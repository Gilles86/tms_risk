...
#SBATCH --output=/home/gdehol/logs/fit_st_denoise_ses2_%A-%a.txt
#SBATCH --ntasks=1
...
"$PY" "$SCRIPT" "$PARTICIPANT_LABEL" 2 --bids_folder "$BIDS" --smoothed
"$PY" "$SCRIPT" "$PARTICIPANT_LABEL" 2 --bids_folder "$BIDS"
