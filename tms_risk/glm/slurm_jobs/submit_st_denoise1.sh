...
#SBATCH --output=/home/gdehol/logs/fit_st_denoise_ses1_%A-%a.txt
#SBATCH --ntasks=1
...
"$PY" "$SCRIPT" "$PARTICIPANT_LABEL" 1 --bids_folder "$BIDS" --smoothed
"$PY" "$SCRIPT" "$PARTICIPANT_LABEL" 1 --bids_folder "$BIDS"
