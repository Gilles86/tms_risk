...
- **Canonical IPS / Vertex palette**: `tms_risk.behavior.utils.stimulation_palette = sns.color_palette()[2:4]` → **IPS = `#2ca02c` green, Vertex = `#d62728` red** (alphabetical mapping). Use this in *every* IPS-vs-vertex figure for visual consistency with the paper's PPC plots.
